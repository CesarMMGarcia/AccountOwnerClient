      ...
      <Layout>
        <Switch>
          ...
          <Route
            ...
            component={AsyncOwnerDetails}
          />
          <Route path='/createOwner/' component={AsyncCreateOwner} />
          <Route
            path='/updateOwner/:id'
            component={AsyncUpdateOwner}
          />
          <Route
            path='/deleteOwner/:id'
            component={AsyncDeleteOwner}
          />
          <Route
            path='/createAccount/:ownerId'
            component={AsyncCreateAccount}
          />
          <Route
            path='/updateAccount/:id'
            component={AsyncUpdateAccount}
          />
          <Route
            path='/deleteAccount/:id'
            component={AsyncDeleteAccount}
          />
